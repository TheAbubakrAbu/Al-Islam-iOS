...
- When merging the iCloud keys into a sibling's main entitlements file, set its container identifier to the container registered for that sibling. Do not copy Al-Islam's container identifier or assume a bundle-derived name is registered.
