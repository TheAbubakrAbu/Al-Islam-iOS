        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("THE SCHOLARS AMONG THE COMPANIONS")) {
                    ...
                    ScholarEntry(name: "Zayd ibn Thabit", arabic: "زَيدُ بنُ ثَابِتٍ", meta: "d. 45 AH / 665 CE · Madinah", description: "The Prophet’s scribe of revelation, who learned the script of the Jews at his command in about half a month (Sunan Abi Dawud 3645; Sunan al-Tirmidhi 2715; graded hasan sahih by al-Albani). The most knowledgeable in inheritance law (Sunan al-Tirmidhi 3790), he was chosen by Abu Bakr to collect the Quran and by Uthman to head its transcription.")

                    ScholarEntry(name: "Mu‘adh ibn Jabal", arabic: "مُعَاذُ بنُ جَبَلٍ", meta: "d. 18 AH / 639 CE · Syria", description: "The most knowledgeable in the lawful and the unlawful (Sunan al-Tirmidhi 3790). The Prophet (peace be upon him) sent him to Yemen as teacher and judge with the words, “let the first thing you call them to be the tawhid of Allah“ (Sahih al-Bukhari 7372), and rode with him while teaching him the right of Allah upon His servants (Sahih al-Bukhari 2856).")

                    ScholarEntry(name: "Ubayy ibn Ka‘b", arabic: "أُبَيُّ بنُ كَعبٍ", meta: "d. c. 22 AH / 643 CE · Madinah", description: "The master of the reciters. Allah commanded the Prophet (peace be upon him) to recite Surat al-Bayyinah to him by name, and Ubayy wept (Sahih al-Bukhari 4959). Umar chose him to lead the Tarawih prayer.")
                ...
                Section(header: ArticleHeader("KEY TERMS")) {
                    Text(articleMarkdown: "**Sahabi (صَحَابِيّ)**: a Companion, from the root ص-ح-ب, “to accompany.“ Ibn Hajar (may Allah have mercy on him) gives the accepted definition in al-Isabah:")
                        .font(.body)
                    ...
                    Text(articleMarkdown: "**Isnad (إِسنَاد)**: “chain of support,“ from the root س-ن-د, “to lean upon“: the chain of narrators by which a hadith reaches us: “so-and-so told me, from so-and-so, from the Prophet.“ Abdullah ibn al-Mubarak’s words that the isnad is part of the religion are quoted on the page “The Salaf and the Imams.“ Muhammad ibn Sirin described how the demand for it began:")
                        .font(.body)
                    ScriptureQuote(text: "“They did not use to ask about the isnad, but when the fitnah occurred they said: name your men to us. So the people of the Sunnah were looked at and their hadith taken, and the people of innovation were looked at and their hadith not taken” (Muqaddimah of Sahih Muslim).", arabic: "لَم يَكُونُوا يَسأَلُونَ عَنِ الإِسنَادِ، فَلَمَّا وَقَعَتِ الفِتنَةُ قَالُوا: سَمُّوا لَنَا رِجَالَكُم، فَيُنظَرُ إِلَى أَهلِ السُّنَّةِ فَيُؤخَذُ حَدِيثُهُم، وَيُنظَرُ إِلَى أَهلِ البِدَعِ فَلاَ يُؤخَذُ حَدِيثُهُم", dimmed: true)
                    ...
                    Text(articleMarkdown: "**Siyar (سِيَر)**: plural of sirah (سِيرَة), “way of life,“ from the root س-ي-ر, “to travel“: biographies. The greatest work of the kind is Siyar A‘lam an-Nubala’ of adh-Dhahabi, the lives of the notable figures of the nation from the Companions to his own day, and the source of much on these pages.")
                        .font(.body)

                    Text(articleMarkdown: "**Tabaqat (طَبَقَات)**: “layers“ or “generations,“ from the root ط-ب-ق. The scholars arranged the narrators and the jurists in generations, the Companions, then the Tabi‘un, and so on, in books such as at-Tabaqat al-Kubra of Ibn Sa‘d, Tabaqat al-Hanabilah of Ibn Abi Ya‘la, and Tabaqat ash-Shafi‘iyyah of as-Subki, so that a chain can be checked: each narrator must have lived in the generation that could meet the one above him.")
                        .font(.body)
                }

                ArticleSourcesSection(article: "SahabahScholarsView")
            }
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("THE TABI'UN (SUCCESSORS)")) {
                    Text(articleMarkdown: "The **Tabi‘un (التَّابِعُون)** met the Companions and took the religion from them. The Prophet (peace be upon him) called them the second best generation (Sahih al-Bukhari 2652). Among the greatest:")
                        .font(.body)

                    ScholarEntry(name: "Sa‘id ibn al-Musayyib", arabic: "سَعِيدُ بنُ المُسَيَّبِ", meta: "d. 94 AH / 713 CE · Madinah", description: "The master of the Tabi‘un and chief of the seven jurists of Madinah, married to the daughter of Abu Hurayrah and the most knowledgeable of the people in the judgements of Umar.")
                    ...
                    ScholarEntry(name: "Mujahid ibn Jabr", arabic: "مُجَاهِدُ بنُ جَبرٍ", meta: "d. 104 AH / 722 CE · Makkah", description: "Who said he read the Quran to Ibn Abbas three times, stopping at every verse to ask about it. His explanations fill the tafsir of at-Tabari.")

                    ScholarEntry(name: "Sa‘id ibn Jubayr, Ikrimah, Ata’ ibn Abi Rabah", arabic: "تَلَامِيذُ ابنِ عَبَّاسٍ", meta: "d. 95, 105, 114 AH · Kufah and Makkah", description: "The three other great students of Ibn Abbas. Sa‘id ibn Jubayr was killed by al-Hajjaj in 95 AH after the revolt of Ibn al-Ash‘ath, and his death is counted a martyrdom; Ikrimah carried his master’s tafsir; Ata’ was the mufti of Makkah in the Hajj season.")

                    ScholarEntry(name: "Muhammad ibn Sirin", arabic: "مُحَمَّدُ بنُ سِيرِينَ", meta: "d. 110 AH / 728 CE · Basrah", description: "The scrupulous jurist who said, “This knowledge is religion, so look from whom you take your religion“ (Muqaddimah of Sahih Muslim). His caution about narrators is the seed of the science of hadith criticism.")
                    ...
                    ScholarEntry(name: "Umar ibn Abd al-Aziz", arabic: "عُمَرُ بنُ عَبدِ العَزِيزِ", meta: "d. 101 AH / 720 CE · Syria", description: "The just caliph counted among the rightly guided, who ordered the first official writing down of the hadith and returned the wealth of the state to the people.")

                    ScholarEntry(name: "Ibn Shihab az-Zuhri", arabic: "ابنُ شِهَابٍ الزُّهرِيُّ", meta: "d. 124 AH / 742 CE · Madinah", description: "The first to systematically record the hadith of Madinah, the teacher of Malik, and a narrator in the chains of a huge part of the Sunnah.")
                }

                Section(header: ArticleHeader("THE IMAMS OF FIQH")) {
                    Text(articleMarkdown: "The students of the Tabi‘un, the **Atba‘ at-Tabi‘in**, were the third generation. Among them the four imams of the schools of fiqh (see “The Madhahib of Fiqh“): **Abu Hanifah** (80–150 AH), **Malik** (93–179 AH), **al-Shafi‘i** (150–204 AH), and **Ahmad ibn Hanbal** (164–241 AH). Beside them stood imams of equal rank whose schools did not survive as madhahib but whose knowledge did:")
                        .font(.body)

                    ScholarEntry(name: "Al-Awza‘i", arabic: "الأَوزَاعِي", meta: "88–157 AH · Beirut, Syria", description: "The imam of Syria, whose school was followed there and in Andalusia for two centuries, and who said, “Hold to the narrations of those who came before, even if the people reject you“ (al-Khatib al-Baghdadi, Sharaf Ashab al-Hadith; al-Lalaka’i, Sharh Usul I‘tiqad Ahl as-Sunnah).")

                    ScholarEntry(name: "Sufyan al-Thawri", arabic: "سُفيَان الثَّورِي", meta: "97–161 AH · Kufah", description: "Called “the Commander of the Believers in hadith,“ a jurist with his own school, and the ascetic who said innovation is more beloved to Iblis than sin, for sin is repented of and innovation is not (al-Lalaka’i, Sharh Usul I‘tiqad Ahl as-Sunnah 238).")

                    ScholarEntry(name: "Al-Layth ibn Sa‘d", arabic: "اللَّيثُ بنُ سَعدٍ", meta: "94–175 AH · Egypt", description: "The imam of Egypt, of whom al-Shafi‘i said he was a greater jurist than Malik but his students did not preserve his school.")

                    ScholarEntry(name: "Abdullah ibn al-Mubarak", arabic: "عَبدُ اللَّهِ بنُ المُبَارَكِ", meta: "118–181 AH · Marw, Khurasan", description: "Scholar, merchant, warrior, and ascetic in one; the author of az-Zuhd and al-Jihad, and the man who said, “The isnad is part of the religion; were it not for the isnad, anyone would say whatever he wished“ (Muqaddimah of Sahih Muslim).")

                    ScholarEntry(name: "Sufyan ibn Uyaynah, Waki‘, al-Fudayl ibn Iyad", arabic: "ابنُ عُيَينَةَ، وَكِيعٌ، الفُضَيلُ", meta: "d. 198, 197, 187 AH · Makkah and Kufah", description: "Sufyan ibn Uyaynah, the hadith master of Makkah and teacher of al-Shafi‘i and Ahmad; Waki‘ ibn al-Jarrah, the teacher of al-Shafi‘i and Ahmad in Kufah; and al-Fudayl ibn Iyad, the repentant highwayman who became the worshipper of the Haram, whose words on sincerity the Salaf passed down.")
                }

                Section(header: ArticleHeader("THE IMAMS OF HADITH")) {
                    Text(verbatim: "The generation after the four imams gave the nation the collections in which the Sunnah is preserved:")
                        .font(.body)
                    ...
                    ScholarEntry(name: "Ad-Darimi, Ibn Khuzaymah, Ibn Hibban, ad-Daraqutni, al-Hakim, al-Bayhaqi", arabic: "الحُفَّاظ", meta: "3rd to 5th century AH", description: "The hadith masters whose Sunan, Sahihs, and Mustadrak preserved what the six left, and whose books on creed (al-Bukhari’s Khalq Af‘al al-‘Ibad, ad-Darimi’s reply to the Jahmiyyah, Ibn Khuzaymah’s Kitab al-Tawhid) recorded the Athari creed with its evidences; al-Bayhaqi, though Ash‘ari in creed, preserved in al-Asma’ was-Sifat the narrations of the Salaf on the attributes.")

                    ScholarEntry(name: "Al-Barbahari, Ibn Battah, al-Lalaka’i, Ibn Abd al-Barr, al-Khatib al-Baghdadi", arabic: "أَئِمَّة السُّنَّة", meta: "d. 329, 387, 418, 463, 463 AH", description: "Al-Barbahari and Ibn Battah, the Hanbali imams of Iraq, and the Shafi‘i al-Lalaka’i, who wrote the creed of the Salaf down sect by sect (Sharh as-Sunnah, al-Ibanah, Sharh Usul I‘tiqad Ahl as-Sunnah); the Maliki Ibn Abd al-Barr of Andalusia, the hadith master of the West; and al-Khatib, the historian of Baghdad and author of Sharaf Ashab al-Hadith.")
                }
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("HIS LIFE")) {
                    Text(articleMarkdown: "**Abu Ja‘far Muhammad ibn Jarir at-Tabari (مُحَمَّدُ بنُ جَرِيرٍ الطَّبَرِيُّ)** was born in 224 AH / 839 CE in Amul in Tabaristan, on the southern shore of the Caspian Sea. He memorised the Quran at seven, led the prayer at eight, and wrote hadith at nine. He travelled to Rayy, Baghdad, Basrah, Kufah, Syria, and Egypt in search of knowledge, then settled in Baghdad, where he taught until his death in 310 AH / 923 CE.")
                        .font(.body)

                    Text(verbatim: "He never married, ate little, and is said to have written forty pages a day for forty years. He refused gifts from rulers and the office of judge, living from a small income sent by his father from Tabaristan.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS WORKS")) {
                    Text(articleMarkdown: "**Jami‘ al-Bayan ‘an Ta’wil Ay al-Quran (جَامِع البَيَان)**, known as Tafsir at-Tabari: the mother of all books of tafsir. For each verse he gathers the explanations of the Companions and the Tabi‘un with their chains of narration, weighs them, and gives his judgement with the reasoning from the Arabic language. Later works of tafsir bil-ma’thur, including Ibn Kathir’s, draw on it.")
                        .font(.body)

                    Text(articleMarkdown: "**Tarikh ar-Rusul wal-Muluk (تَارِيخ الرُّسُل وَالمُلُوك)**, the History of the Prophets and Kings: the great chronicle from the creation to the year 302 AH, in which the reports are given with their chains so that the reader can judge them, since he warned in its introduction that he was a transmitter, not a guarantor, of what he collected.")
                        .font(.body)

                    Text(articleMarkdown: "**Tahdhib al-Athar**, a hadith work left unfinished; **Ikhtilaf al-Fuqaha’** on the differences of the jurists; and **Sarih as-Sunnah (صَرِيح السُّنَّة)**, his short statement of creed.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS CREED")) {
                    Text(verbatim: "In Sarih as-Sunnah he laid out the belief of Ahl as-Sunnah: that the Quran is the speech of Allah, uncreated; that the believers will see their Lord on the Day of Resurrection; that faith is word and deed and increases and decreases; that the decree, good and bad, is from Allah; and that the best of the nation after its Prophet are Abu Bakr, Umar, Uthman, and Ali. He affirmed the attributes as they came, and his tafsir on the verse of the Throne affirms Allah’s rising without asking how.")
                        .font(.body)

                    Text(verbatim: "He was a mujtahid whose own school of fiqh, the Jaririyyah, was followed for a time and then faded, which shows that a man can be an imam of the nation without leaving behind a madhhab.")
                        .font(.body)
                }
    ...
    var body: some View {
        List {
            Group {
                ...
                Section(header: ArticleHeader("HIS LIFE")) {
                    Text(articleMarkdown: "**Taqi ad-Din Ahmad ibn Abd al-Halim ibn Abd as-Salam ibn Taymiyyah (أَحمَدُ بنُ عَبدِ الحَلِيمِ بنِ تَيمِيَّةَ)** was born on 10 Rabi‘ al-Awwal 661 AH / 22 January 1263 CE in Harran, in a family of Hanbali scholars. When the Mongols advanced, the family fled to Damascus in 667 AH, carrying their books on a cart. His father taught at the Umayyad Mosque, and when he died in 682 AH the son, at twenty-one, took his teaching post.")
                        .font(.body)

                    Text(verbatim: "He memorised the Quran as a child and mastered hadith, fiqh, Arabic, tafsir, and the books of the sects and the philosophers, so that he could refute them from their own words. He never married, lived simply, and gave away what he had.")
                        .font(.body)
                }

                Section(header: ArticleHeader("THE MONGOLS AND THE TRIALS")) {
                    Text(verbatim: "When the Mongols under Ghazan took Damascus in 699 AH, he went to the Mongol camp himself and demanded the release of the prisoners. In 702 AH, at the battle of Shaqhab, he stood among the soldiers, gave the fatwa that fighting the Mongols was obligatory although they professed Islam, since they ruled by the Yasa of Genghis Khan, and swore to the hesitant that Allah would give victory. The Mongols were defeated.")
                        .font(.body)

                    Text(verbatim: "His refutations of grave-worship, of the philosophers, and of the theologians made him enemies among the rulers’ scholars. He was imprisoned in Cairo (705–707 AH) over his creed, in Alexandria in 709 AH, in the citadel of Damascus in 720 AH over a fatwa on divorce, and finally in 726 AH over his ruling that travelling to visit graves is not legislated. Denied ink and paper in the end, he died in the citadel on 20 Dhul-Qa‘dah 728 AH / 26 September 1328 CE. Ibn Kathir records that the crowd at his funeral was beyond counting, the largest Damascus had seen.")
                        .font(.body)

                    Text(verbatim: "Ibn al-Qayyim heard him say in prison:")
                        .font(.body)
                    ScriptureQuote(text: "“What can my enemies do to me? My paradise and my garden are in my breast; wherever I go they go with me and never leave me. My imprisonment is seclusion, my killing is martyrdom, and my expulsion from my land is travel” (Ibn al-Qayyim, al-Wabil as-Sayyib, p. 48).", arabic: "مَا يَصنَعُ أَعدَائِي بِي؟ أَنَا جَنَّتِي وَبُستَانِي فِي صَدرِي، أَينَ رُحتُ فَهِيَ مَعِي لَا تُفَارِقُنِي، إِنَّ حَبسِي خَلوَةٌ، وَقَتلِي شَهَادَةٌ، وَإِخرَاجِي مِن بَلَدِي سِيَاحَةٌ", dimmed: true)
                }

                Section(header: ArticleHeader("HIS WORKS")) {
                    Text(articleMarkdown: "**Al-Aqidah al-Wasitiyyah (العَقِيدَة الوَاسِطِيَّة)**: the creed of the Salaf in a few pages, written in one sitting for a judge from Wasit, and examined and approved in three public debates in Damascus in 705 AH.")
                        .font(.body)
                    Text(articleMarkdown: "**Minhaj as-Sunnah an-Nabawiyyah (مِنهَاج السُّنَّة النَّبَوِيَّة)**: the reply to the Rafidi Ibn al-Mutahhar al-Hilli, and the most complete defence of the Companions and the caliphate ever written.")
                        .font(.body)
                    Text(articleMarkdown: "**Dar’ Ta‘arud al-‘Aql wan-Naql**: showing that sound reason never contradicts authentic revelation, and answering the kalam theologians on their own ground.")
                        .font(.body)
                    Text(articleMarkdown: "**Iqtida’ as-Sirat al-Mustaqim**: on innovations and on imitating the disbelievers in their festivals. **Al-Jawab as-Sahih**: the reply to Christianity. **Ar-Radd ‘ala al-Mantiqiyyin**: the refutation of Greek logic. **Al-‘Ubudiyyah**, **Al-Furqan**, **As-Siyasah ash-Shar‘iyyah**, and hundreds of treatises gathered in the thirty-seven volumes of **Majmu‘ al-Fatawa (مَجمُوع الفَتَاوَى)**.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS STUDENTS")) {
                    Text(articleMarkdown: "His greatest legacy is the men he taught and who kept his company: **Ibn al-Qayyim**, who never left him from 712 AH and was imprisoned with him; **adh-Dhahabi**, the historian of Islam; **Ibn Kathir**, the mufassir and historian; **al-Mizzi**, his older companion and the master of the narrators of the six books; **Ibn Abd al-Hadi**, who wrote his biography; **Ibn Muflih**, the Hanbali jurist; and **al-Bazzar**, who recorded his manners. Ibn al-Qayyim, adh-Dhahabi, and Ibn Kathir have their own articles here.")
                        .font(.body)

                    Text(verbatim: "Adh-Dhahabi wrote that he had not seen anyone like him, and Ibn Hajar al-Asqalani, who differed with him on some matters, endorsed the book defending him and wrote that his fame needs no description. Like every scholar after the Prophet (peace be upon him), he could err, and the scholars of the Sunnah accepted from him what agreed with the evidence and left what did not, which is exactly what he asked of them.")
                        .font(.body)
                }
    ...
    var body: some View {
        List {
            Group {
                ...
                Section(header: ArticleHeader("HIS LIFE")) {
                    Text(articleMarkdown: "**Shams ad-Din Muhammad ibn Abi Bakr ibn Ayyub (مُحَمَّدُ بنُ أَبِي بَكرٍ ابنُ قَيِّمِ الجَوزِيَّةِ)** was born in 691 AH / 1292 CE in Damascus. His father was the **qayyim**, the caretaker, of the Jawziyyah school, hence the name Ibn Qayyim al-Jawziyyah. He studied every science of the religion with the scholars of Damascus and, from 712 AH, devoted himself to Ibn Taymiyyah, staying with him until the shaykh died in 728 AH.")
                        .font(.body)

                    Text(verbatim: "He was imprisoned with his teacher in the citadel for holding that travelling to visit graves is not legislated, and was released after the shaykh’s death. He spent the prison reading the Quran and in reflection, and later said it opened to him what he could not have gained outside. He taught at the Sadriyyah school, led prayer at the Jawziyyah, performed Hajj many times, and died on 13 Rajab 751 AH / 1350 CE.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS WORKS")) {
                    Text(articleMarkdown: "**Madarij as-Salikin (مَدَارِج السَّالِكِين)**: the stations of the journey to Allah, taking the language of the Sufis and correcting it by the Quran and the Sunnah; his masterpiece on the purification of the heart.")
                        .font(.body)
                    Text(articleMarkdown: "**Zad al-Ma‘ad (زَاد المَعَاد)**: the guidance of the Prophet (peace be upon him) in every part of life, from worship to medicine, drawn from the seerah and the hadith.")
                        .font(.body)
                    Text(articleMarkdown: "**I‘lam al-Muwaqqi‘in (إِعلَام المُوَقِّعِين)**: the principles of law and fatwa, and the danger of blind following.")
                        .font(.body)
                    Text(articleMarkdown: "**Al-Wabil as-Sayyib** on dhikr; **Ad-Da’ wad-Dawa’** (al-Jawab al-Kafi) on sin and its cure; **Ighathat al-Lahfan** on the snares of Shaytan and the shirk of the grave-worshippers; **Ar-Ruh** on the soul; **Miftah Dar as-Sa‘adah** on knowledge; **Al-Fawa’id**; **Hadi al-Arwah** on Paradise; and **al-Kafiyah ash-Shafiyah** (an-Nuniyyah), a poem of some six thousand lines on the creed of the Salaf.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS WORDS")) {
                    ScriptureQuote(text: "“In the heart is a disorder that nothing gathers except turning to Allah; in it is a loneliness that nothing removes except intimacy with Him in solitude; in it is a sorrow that nothing takes away except the joy of knowing Him and the truthfulness of dealing with Him” (Madarij as-Salikin 3/156).", arabic: "فِي القَلبِ شَعَثٌ لَا يَلُمُّهُ إِلَّا الإِقبَالُ عَلَى اللَّهِ، وَفِيهِ وَحشَةٌ لَا يُزِيلُهَا إِلَّا الأُنسُ بِهِ فِي خَلوَتِهِ، وَفِيهِ حُزنٌ لَا يُذهِبُهُ إِلَّا السُّرُورُ بِمَعرِفَتِهِ وَصِدقِ مُعَامَلَتِهِ", dimmed: true)

                    Text(articleMarkdown: "His students included **Ibn Kathir**, who said he had not seen anyone who worshipped more than him, and **Ibn Rajab al-Hanbali**, the author of Jami‘ al-‘Ulum wal-Hikam, who studied with him in his last years.")
                        .font(.body)
                }
    ...
    var body: some View {
        List {
            Group {
                ...
                Section(header: ArticleHeader("HIS LIFE")) {
                    Text(articleMarkdown: "**Shams ad-Din Muhammad ibn Ahmad ibn Uthman adh-Dhahabi (مُحَمَّدُ بنُ أَحمَدَ الذَّهَبِيُّ)** was born in 673 AH / 1274 CE in Damascus to a family of Turkmen origin; his name comes from his father’s trade in gold. He began with the Quran and its readings, then gave himself to hadith, travelling to Ba‘labakk, Aleppo, Cairo, Alexandria, Makkah, and Madinah and hearing from more than a thousand teachers.")
                        .font(.body)

                    Text(verbatim: "In Damascus he studied with Ibn Taymiyyah and al-Mizzi, and was appointed to teach hadith at several schools, including Turbat Umm as-Salih, an-Nafisiyyah, and at-Tankiziyyah. He lost his sight in his last years and died in 748 AH / 1348 CE.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS WORKS")) {
                    Text(articleMarkdown: "**Siyar A‘lam an-Nubala’ (سِيَر أَعلَام النُّبَلَاء)**: the biographies of the notable figures of Islam from the Companions to his own time, in some twenty-five volumes, with his own judgements on their knowledge, creed, and character.")
                        .font(.body)
                    Text(articleMarkdown: "**Tarikh al-Islam (تَارِيخ الإِسلَام)**: the history of Islam by decade with the deaths of the notable men of each, the largest work of its kind.")
                        .font(.body)
                    Text(articleMarkdown: "**Mizan al-I‘tidal**: the criticised narrators of hadith, one by one, with the verdicts of the imams. **Tadhkirat al-Huffaz**: the generations of the hadith masters. **Al-Kashif** on the narrators of the six books. **Talkhis al-Mustadrak**, his check on al-Hakim’s claims of authenticity.")
                        .font(.body)
                    Text(articleMarkdown: "**Al-‘Uluww lil-‘Aliyy al-Ghaffar (العُلُوّ)**: the sayings of the Salaf affirming that Allah is above His creation, gathered generation by generation; and **al-Kaba’ir**, the major sins with their evidences.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS STANDARD")) {
                    Text(articleMarkdown: "Describing the qualities a hadith master needs, he wrote that he must be pious, intelligent, learned in grammar and language, upright, modest, and **Salafi** (Siyar A‘lam an-Nubala’ 13/380), and throughout his biographies he praises scholars for being upon the creed of the Salaf and records where others fell into kalam. Of his teacher Ibn Taymiyyah he wrote that his like had not been seen, while noting his own reservations with fairness; this balance is why his verdicts are trusted by all.")
                        .font(.body)

                    Text(verbatim: "He warned the scholars of his time against pride in knowledge, and his short treatises of advice, such as Bayan Zaghal al-‘Ilm wat-Talab, show the humility the Salaf demanded of the learned.")
                        .font(.body)
                }
    ...
    var body: some View {
        List {
            Group {
                ...
                Section(header: ArticleHeader("HIS LIFE")) {
                    Text(articleMarkdown: "**Imad ad-Din Isma‘il ibn Umar ibn Kathir (إِسمَاعِيلُ بنُ عُمَرَ بنِ كَثِيرٍ)** was born in 701 AH / 1301 CE in a village near Busra in Syria. His father, a preacher, died when he was a small child, and his elder brother brought him to Damascus in 706 AH, where he memorised the Quran and studied with the great scholars of the city.")
                        .font(.body)

                    Text(articleMarkdown: "He was the student of **al-Mizzi**, whose daughter he married, of **Ibn Taymiyyah**, whom he loved and defended, and of **adh-Dhahabi**. A Shafi‘i in fiqh, he taught at the Umayyad Mosque and several schools and succeeded adh-Dhahabi at the Umm as-Salih school. He lost his sight at the end of his life and died in Sha‘ban 774 AH / 1373 CE. By his own wish he was buried beside his teacher Ibn Taymiyyah in the Sufi cemetery of Damascus.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS WORKS")) {
                    Text(articleMarkdown: "**Tafsir al-Quran al-‘Azim (تَفسِير القُرآن العَظِيم)**: the tafsir most read by Muslims today, in which he explains each verse by other verses, then by the hadith with its grade, then by the Companions and Tabi‘un, and warns against the Israelite reports and weak narrations. He set out the method in his introduction, quoting his teacher Ibn Taymiyyah’s Muqaddimah fi Usul at-Tafsir:")
                        .font(.body)
                    ScriptureQuote(text: "“If someone asks: what is the best method of tafsir? The answer is that the soundest method is that the Quran be explained by the Quran; what is left general in one place is explained in another. If that defeats you, then by the Sunnah, for it explains the Quran and clarifies it” (Ibn Taymiyyah, Muqaddimah fi Usul at-Tafsir, quoted in the introduction of Tafsir Ibn Kathir).", arabic: "فَإِن قَالَ قَائِلٌ: فَمَا أَحسَنُ طُرُقِ التَّفسِيرِ؟ فَالجَوَابُ: إِنَّ أَصَحَّ الطُّرُقِ فِي ذَلِكَ أَن يُفَسَّرَ القُرآنُ بِالقُرآنِ، فَمَا أُجمِلَ فِي مَكَانٍ فَإِنَّهُ قَد فُسِّرَ فِي مَوضِعٍ آخَرَ، فَإِن أَعيَاكَ ذَلِكَ فَعَلَيكَ بِالسُّنَّةِ فَإِنَّهَا شَارِحَةٌ لِلقُرآنِ وَمُوَضِّحَةٌ لَهُ", dimmed: true)

                    Text(articleMarkdown: "**Al-Bidayah wan-Nihayah (البِدَايَة وَالنِّهَايَة)**, “The Beginning and the End“: the history of the world from the creation, through the prophets, the seerah in great detail, the caliphates, and the events of every year to 768 AH, ending with the signs of the Hour and the Hereafter. **Qisas al-Anbiya’** (the stories of the prophets) and **as-Sirah an-Nabawiyyah** are drawn from it.")
                        .font(.body)

                    Text(articleMarkdown: "**Jami‘ al-Masanid was-Sunan**, an arrangement of the hadith of the ten books by Companion; **Ikhtisar ‘Ulum al-Hadith**, on the science of hadith; **Tabaqat ash-Shafi‘iyyah**; and a commentary on Sahih al-Bukhari left unfinished.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HIS PLACE")) {
                    Text(verbatim: "Ibn Kathir carried the knowledge of Ibn Taymiyyah and adh-Dhahabi into the two books that every later generation opened first: the tafsir and the history. In his tafsir the creed of the Salaf is stated at every verse of the attributes, and in his history the Companions are defended and the sects are exposed.")
                        .font(.body)
                }
    ...
    var body: some View {
        List {
            Group {
                ...
                Section(header: ArticleHeader("THE SCHOLARS OF OUR ERA")) {
                    ScholarEntry(name: "Abd al-Aziz ibn Baz", arabic: "عَبدُ العَزِيزِ بنُ بَازٍ", meta: "1330–1420 AH / 1910–1999 CE · Riyadh", description: "Blind from the age of twenty, the Grand Mufti of Saudi Arabia, known for his gentleness, his charity, and his fatawa, which were spread across the world, and for his patience in answering every questioner.")
                    ...
                    ScholarEntry(name: "Muhammad ibn Salih al-Uthaymin", arabic: "مُحَمَّدُ بنُ صَالِحٍ العُثَيمِينَ", meta: "1347–1421 AH / 1929–2001 CE · Unayzah", description: "The teacher of the Qasim, whose explanations of al-Wasitiyyah, Kitab at-Tawhid, Riyad as-Salihin, and Bulugh al-Maram, and whose ash-Sharh al-Mumti‘ in fiqh, are the textbooks of students of knowledge today, taught with clarity and with an ease of manner remembered by all who sat with him.")

                    Text(articleMarkdown: "Beside these three stood **Muqbil ibn Hadi al-Wadi‘i** in Yemen, **Muhammad Aman al-Jami** in Madinah and **Ahmad an-Najmi** in Jazan, and their teachers and students. They differed at times in fiqh and in judgement, as scholars do, and were one in creed: the creed of the Salaf.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text(articleMarkdown: "**Are the scholars infallible?**")
                        .font(.body)
                    ...
                    Text(verbatim: "The imams said the same of themselves. Malik’s saying that everyone’s words may be accepted or rejected except those of the one in the Prophet’s grave (Ibn Abd al-Barr, Jami‘ Bayan al-‘Ilm wa Fadlih) is given above. Ash-Shafi‘i (may Allah have mercy on him) said:")
                        .font(.body)
                    ScriptureQuote(text: "“The Muslims are agreed that whoever has a Sunnah of the Messenger of Allah (peace be upon him) made clear to him is not permitted to leave it for the saying of anyone” (Ibn al-Qayyim, I‘lam al-Muwaqqi‘in).", arabic: "أَجمَعَ المُسلِمُونَ عَلَى أَنَّ مَنِ استَبَانَت لَهُ سُنَّةٌ عَن رَسُولِ اللَّهِ صَلَّى اللَّهُ عَلَيهِ وَسَلَّمَ لَم يَحِلَّ لَهُ أَن يَدَعَهَا لِقَولِ أَحَدٍ", dimmed: true)
                    Text(verbatim: "And Ahmad (may Allah have mercy on him) said:")
                        .font(.body)
                    ScriptureQuote(text: "“Do not imitate me, nor Malik, nor ash-Shafi‘i, nor al-Awza‘i, nor ath-Thawri; take from where they took” (Ibn al-Qayyim, I‘lam al-Muwaqqi‘in).", arabic: "لَا تُقَلِّدنِي وَلَا تُقَلِّد مَالِكًا وَلَا الشَّافِعِيَّ وَلَا الأَوزَاعِيَّ وَلَا الثَّورِيَّ، وَخُذ مِن حَيثُ أَخَذُوا", dimmed: true)
                    Text(verbatim: "Ibn Taymiyyah devoted a treatise, Raf‘ al-Malam ‘an al-A’immat al-A‘lam, to explaining why the imams sometimes ruled against a hadith: it had not reached them, or they did not judge it authentic, or they understood it differently, or they held it abrogated. Their error is excused and rewarded, but it is not followed once the evidence is known.")
                        .font(.body)

                    Text(articleMarkdown: "**Whom do I follow when the scholars differ?**")
                        .font(.body)
                    ...
                    Text(articleMarkdown: "**Was Ibn Taymiyyah an anthropomorphist (mujassim)?**")
                        .font(.body)
                    Text(verbatim: "No. The charge was made by his opponents in his lifetime and answered in his lifetime. His own creed, al-Aqidah al-Wasitiyyah, lays down at its beginning:")
                        .font(.body)
                    ...
                    Text(articleMarkdown: "**Did Ibn Taymiyyah hate Ali or the Ahlul Bayt?**")
                        .font(.body)
                    ...
                    Text(articleMarkdown: "**Why do Salafis respect an-Nawawi and Ibn Hajar although they interpreted some attributes?**")
                        .font(.body)
                    ...
                    Text(verbatim: "Ibn Baz and Ibn al-Uthaymin (may Allah have mercy on them), when asked about the two, answered in the same spirit: they are imams of Ahl as-Sunnah whose good is immense, who erred in the interpretation of some attributes, and whose error is not followed. The rule is that of Ahl as-Sunnah in every age: take the truth from whoever brings it, leave the error of whoever falls into it, and ask Allah’s mercy for the scholars.")
                        .font(.body)

                    Text(articleMarkdown: "**How do I know a scholar is trustworthy?**")
                        .font(.body)
                    Text(verbatim: "By the same test the Salaf applied to narrators. Muhammad ibn Sirin (may Allah have mercy on him) said:")
                        .font(.body)
                    ScriptureQuote(text: "“This knowledge is religion, so look from whom you take your religion” (Muqaddimah of Sahih Muslim).", arabic: "إِنَّ هَذَا العِلمَ دِينٌ، فَانظُرُوا عَمَّن تَأخُذُونَ دِينَكُم", dimmed: true)
                    Text(verbatim: "Look for four things. Sound creed: he affirms the names and attributes as they came, honours the Companions, and does not call to any sect. Knowledge of the texts: he speaks from the Quran and the Sunnah with their evidences, not from stories and opinions. A chain of teachers: he sat before known scholars of the Sunnah and they know him, for knowledge is transmission, and the Prophet (peace be upon him) warned that when the scholars are gone people take ignorant heads who give verdicts without knowledge (Sahih al-Bukhari 100). And practice: his fear of Allah shows in his conduct, for Allah says that the knowledgeable are the ones who fear Him (Quran 35:28). A man with a title, a following, or eloquence but without these is not a scholar, however many listen to him.")
                        .font(.body)

                    Text(articleMarkdown: "**Is taking from the scholars blind imitation (taqlid)?**")
                        .font(.body)
                    ...
                    Text(articleMarkdown: "**Were the four imams upon the creed of the Salaf?**")
                        .font(.body)
                    Text(verbatim: "Yes, and their own words prove it. The creed of Abu Hanifah is preserved in al-Fiqh al-Akbar and in the creed of at-Tahawi, who wrote it as the belief of Abu Hanifah and his two companions Abu Yusuf and Muhammad ibn al-Hasan. Malik was asked how Allah rose over the Throne and replied:")
                        .font(.body)
                    ScriptureQuote(text: "“The rising is not unknown, the how of it is beyond reason, belief in it is obligatory, and asking about it is innovation” (al-Lalaka’i, Sharh Usul I‘tiqad Ahl as-Sunnah 664; al-Bayhaqi, al-Asma’ was-Sifat 867).", arabic: "الِاستِوَاءُ غَيرُ مَجهُولٍ، وَالكَيفُ غَيرُ مَعقُولٍ، وَالإِيمَانُ بِهِ وَاجِبٌ، وَالسُّؤَالُ عَنهُ بِدعَةٌ", dimmed: true)
                    Text(verbatim: "Ash-Shafi‘i said:")
                        .font(.body)
                    ...
                    Text(articleMarkdown: "**Is knowledge only for scholars?**")
                        .font(.body)
                    ...
                    Text(articleMarkdown: "**Who are the scholars of our time we can rely on?**")
                        .font(.body)
                    Text(verbatim: "This page names three whose knowledge, creed, and character the scholars of the Sunnah have agreed upon and who have gone to their Lord: Ibn Baz, al-Albani, and Ibn al-Uthaymin (may Allah have mercy on them), with those named beside them. Their books, fatawa, and recorded lessons remain, and they are the safest starting point for a student today, together with the scholars of the Sunnah who learned from them. Abdullah ibn Mas‘ud (may Allah be pleased with him) gave the principle:")
                        .font(.body)
                    ScriptureQuote(text: "“Whoever of you would follow an example, let him follow the example of the Companions of the Messenger of Allah, for they were the most righteous of this nation in heart, the deepest in knowledge, and the least in affectation” (Ibn Abd al-Barr, Jami‘ Bayan al-‘Ilm wa Fadlih; Abu Nu‘aym, Hilyat al-Awliya’ 1/305).", arabic: "مَن كَانَ مِنكُم مُتَأَسِّيًا فَليَتَأَسَّ بِأَصحَابِ رَسُولِ اللَّهِ صَلَّى اللَّهُ عَلَيهِ وَسَلَّمَ، فَإِنَّهُم كَانُوا أَبَرَّ هَذِهِ الأُمَّةِ قُلُوبًا، وَأَعمَقَهَا عِلمًا، وَأَقَلَّهَا تَكَلُّفًا", dimmed: true)
                    Text(verbatim: "For the living, apply the test given above: sound creed, knowledge of the texts, a known chain of teachers, and practice, and ask the people of the Reminder when you do not know, as Allah commanded in the verse of Surat an-Nahl quoted above. The names change from age to age; the test does not.")
                        .font(.body)
                }
