...
private enum DuaCollections {
    ...
    static let rabbana = DuaCollection(
        ...
        items: [
            ...
            DuaItem(arabicText: "وَقَالُواْ ٱلۡحَمۡدُ لِلَّهِ ٱلَّذِيٓ أَذۡهَبَ عَنَّا ٱلۡحَزَنَۖ إِنَّ رَبَّنَا لَغَفُورٞ شَكُورٌ", transliteration: "Inna Rabbanaa la-Ghafoorun Shakoor", translation: "Indeed, our Lord is Forgiving and Appreciative.", reference: "35:34"),
