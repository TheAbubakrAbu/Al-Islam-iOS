        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("BEFORE YOU PRAY")) {
                    ...
                    Text("2. **Cover the Awrah (عَورَة)**: men from the navel to the knee at least; women cover everything except the face and hands (and, according to most scholars, the feet as well).").font(.body)
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("3. CALCULATE 2.5%")) {
                    Text("If your total is at or above the Nisab after the year has passed, give **2.5%** (one fortieth) of it. It becomes due the moment the year completes and must not be delayed past that; it may be paid early, so many bring it forward to Ramadan for the extra reward.")
                        .font(.body)
                }
...
struct TayammumView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **Tayammum (تَيَمُّم)** is the dry purification Allah allows when water cannot be found or cannot be used: make the intention, strike clean earth once with both palms, and wipe the face and then the hands. It stands in for wudhu and for ghusl alike, and it ends the moment water becomes usable.")
                        .font(.body)
                }

                Section(header: ArticleHeader("WHEN IT IS ALLOWED")) {
                    Text("Tayammum is permitted in two cases: when there is no water at all (or none to spare after drinking needs), and when water is there but using it would harm you, as with an illness, a wound, or severe cold with no way to warm it. Allah says:")
                        .font(.body)
                    ...
                    Text("The Prophet (peace and blessings be upon him) counted this ease among the special gifts to his ummah:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("WHAT TO USE")) {
                    Text("Anything that is of the earth's surface and is clean: soil, sand, dust, or a stone or dusty wall. Allah calls it **sa'id tayyib (صَعِيد طَيِّب)**, clean earth. It need not leave visible dust on the hands; a light strike is enough.")
                        .font(.body)
                }

                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("1. **Intention (Niyyah)**: intend in the heart to purify yourself for prayer. Say “Bismillah.”").font(.body)
                    Text("2. **Strike the earth once** with both palms, lightly, then blow on them or shake off the excess dust.").font(.body)
                    Text("3. **Wipe the face** with both hands, once.").font(.body)
                    Text("4. **Wipe the hands**: the back of the right hand with the left palm and the back of the left hand with the right palm, up to the wrists.").font(.body)
                    Text("That is the whole of it. When Ammar ibn Yasir (may Allah be pleased with him) rolled in the dust to purify himself from janabah, the Prophet (peace and blessings be upon him) corrected him:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("WHAT BREAKS IT")) {
                    Text("Everything that breaks wudhu breaks tayammum. In addition, tayammum ends when the excuse ends: when water is found, or when using it is no longer harmful. A prayer already completed with tayammum is valid and is not repeated.")
                        .font(.body)
                    Text("Tayammum done in place of ghusl is likewise a full substitute until water can be used; then a ghusl is made.")
                        .font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Can tayammum replace ghusl?** Yes. Ammar's case above was janabah, and the Prophet (peace and blessings be upon him) taught him tayammum for it. When water becomes available, make ghusl for what follows.").font(.body)
                    Text("**Does one tayammum cover several prayers?** It remains valid, like wudhu, until it is broken or until water becomes usable. This is the stronger view among the scholars, since the Prophet named the earth a purification without limiting it to one prayer.").font(.body)
                    Text("**A wound is bandaged. Do I still make tayammum?** Wash what you can, wipe over the bandage, and complete the wudhu. Tayammum is for the part that can take neither washing nor wiping, and some scholars regard the wipe over the bandage as sufficient on its own. Ask a scholar about a persistent condition.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("When water is missing or harmful, strike clean earth once, wipe the face and then the hands, and pray. It is Allah's ease for this ummah, and it lasts until water can be used again.")
                        .font(.body)
                }
...
struct RawatibView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: the **Sunnah Rawatib (السُّنَن الرَّوَاتِب)** are the twelve voluntary rak'ah the Prophet (peace and blessings be upon him) kept around the five prayers every day: four before Dhuhr and two after, two after Maghrib, two after Isha, and two before Fajr. Whoever keeps them is promised a house in Paradise.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("THE PROMISE")) {
                    ...
                    Text("Aishah (may Allah be pleased with her) narrated the breakdown:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("THE TWELVE")) {
                    Text("• **Before Fajr**: 2 rak'ah, kept short.").font(.body)
                    Text("• **Before Dhuhr**: 4 rak'ah (two by two), and **after Dhuhr**: 2 rak'ah.").font(.body)
                    Text("• **After Maghrib**: 2 rak'ah.").font(.body)
                    Text("• **After Isha**: 2 rak'ah.").font(.body)
                    Text("Ibn Umar (may Allah be pleased with him) recalled ten of them from the Prophet himself, and named where he prayed them:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("THE TWO BEFORE FAJR")) {
                    Text("Of all the rawatib, the two before Fajr were the ones the Prophet (peace and blessings be upon him) never left, at home or on a journey. He said:")
                        .font(.body)
                    ...
                    Text("He prayed them light, with Surah al-Kafirun and Surah al-Ikhlas after al-Fatihah being his frequent choice (Sahih Muslim 726):")
                        .font(.body)
                ...
                Section(header: ArticleHeader("MORE THAT IS RECOMMENDED")) {
                    Text("Beyond the twelve, other voluntary prayers around the obligatory ones are established and rewarded:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("HOW TO PRAY THEM")) {
                    Text("1. Pray them two rak'ah at a time, each pair ending with the tashahhud and the taslim. Four before Dhuhr are two pairs.").font(.body)
                    Text("2. Intend the specific sunnah in the heart; nothing is spoken.").font(.body)
                    Text("3. Pray them at home when you can, as the Prophet (peace and blessings be upon him) did for the Maghrib and Isha rawatib: he said that the best of a man's prayer is in his house, except the obligatory prayer (Sahih Muslim 781).").font(.body)
                    Text("4. If you miss one, it may be made up: the Prophet made up the two after Dhuhr when he was kept busy (Sahih al-Bukhari 1233), and prayed the two of Fajr after the obligatory prayer when he slept through the time on a journey (Sahih Muslim 681).").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Twelve rak'ah a day, spread around the five prayers, earn a house in Paradise and mend what the obligatory prayer lacked. Guard the two of Fajr above all.")
                        .font(.body)
                }
...
struct WitrView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **Witr (وِتر)**, the odd-numbered prayer, closes the night's prayer. It is prayed after Isha and before Fajr, as one, three, five or more rak'ah ending in one, and the Prophet (peace and blessings be upon him) never left it, at home or on a journey.")
                        .font(.body)
                }

                Section(header: ArticleHeader("ITS STATUS")) {
                    Text("Witr is a strongly emphasized Sunnah, not one of the five obligations. Ali (may Allah be pleased with him) said:")
                        .font(.body)
                    ...
                    Text("Yet the Prophet (peace and blessings be upon him) urged it in the strongest terms and advised it to those he loved:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("ITS TIME")) {
                    Text("From after the Isha prayer until the break of dawn. The best time is the last part of the night for whoever trusts himself to wake; whoever fears he will not should pray it before sleeping.")
                        .font(.body)
                ...
                Section(header: ArticleHeader("HOW MANY RAK'AH")) {
                    Text("• **One** rak'ah on its own is valid Witr:").font(.body)
                    ...
                    Text("• **Three**, either as two rak'ah with taslim then one, or three in one sitting with one tashahhud at the end (not like Maghrib, with a middle sitting).").font(.body)
                    Text("• **Five, seven or nine**, prayed in one sitting with a tashahhud only at the end (in nine, a tashahhud in the eighth and the ninth), as the Prophet (peace and blessings be upon him) prayed at times.").font(.body)
                    Text("• **Eleven or thirteen**: two by two, then one, which was his usual night prayer:").font(.body)
                ...
                Section(header: ArticleHeader("WHAT TO RECITE")) {
                    Text("In three rak'ah of Witr, the Prophet (peace and blessings be upon him) recited al-A'la in the first, al-Kafirun in the second and al-Ikhlas in the third:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("THE QUNUT")) {
                    Text("A supplication (**qunut, قُنُوت**) in the last rak'ah, before or after the ruku, is Sunnah. The Prophet (peace and blessings be upon him) taught al-Hasan ibn Ali these words:")
                        .font(.body)
                    ...
                    Text("After the taslim he would say, three times, raising his voice on the third:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**I slept through Witr. Can I make it up?** Yes. The Prophet (peace and blessings be upon him) said that whoever sleeps through his Witr or forgets it should pray it when he wakes or remembers (Sunan Abi Dawud 1431; Sunan al-Tirmidhi 465; graded sahih by al-Albani); it may be prayed in the day after Fajr, and some scholars say as an even number then.").font(.body)
                    Text("**Can I pray Witr, then pray more at night?** Whoever prays Witr early and then wakes may pray as he wishes, two by two, without repeating Witr: “There are no two Witr in one night” (Sunan al-Tirmidhi 470; Sunan Abi Dawud 1439; graded sahih by al-Albani).").font(.body)
                    Text("**Is Witr the same as Tahajjud?** Witr is the closing rak'ah; Tahajjud is the whole of the night prayer it closes. Praying only Witr is valid; praying Tahajjud without Witr leaves it incomplete.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Close every night with Witr, an odd number ending in one, with a qunut in the last rak'ah. If you will not wake, pray it before you sleep; if you will, make it the last thing you pray before dawn.")
                        .font(.body)
                }
...
struct TahajjudView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **Tahajjud (تَهَجُّد)**, or Qiyam al-Layl, is the voluntary prayer offered after sleeping some of the night, prayed two rak'ah at a time and closed with Witr. It is the best prayer after the obligatory ones, and the hour in which Allah asks who is calling on Him.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("ITS TIME")) {
                    Text("Any time after Isha and before Fajr is night prayer; the last third is best. To sleep first and then rise is what the word tahajjud means, and it is what the Prophet (peace and blessings be upon him) did, and what he praised in Dawud (peace be upon him):")
                        .font(.body)
                ...
                Section(header: ArticleHeader("HOW MANY RAK'AH")) {
                    Text("There is no fixed number; two rak'ah are night prayer. The Prophet's own habit was eleven, and at times thirteen:")
                        .font(.body)
                    ...
                    Text("Long rak'ah with few in number was his way, and he said of the night prayer that it is offered two by two, ending in one (Sahih al-Bukhari 990).")
                        .font(.body)
                }

                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("1. **Sleep with the intention** of rising. The intention itself is written for you even if sleep overcomes you (Sunan an-Nasa'i 1787; Sunan Ibn Majah 1344; graded sahih by al-Albani).").font(.body)
                    Text("2. **On waking**, say the remembrance of waking, make wudhu, and begin. Satan ties three knots on the sleeper; remembering Allah undoes one, wudhu the second, and prayer the third (Sahih al-Bukhari 1142).").font(.body)
                    Text("3. **Open with two short rak'ah**, as the Prophet (peace and blessings be upon him) did (Sahih Muslim 767), then lengthen what follows.").font(.body)
                    Text("4. **Pray two by two**, reciting slowly, with long standing, bowing and prostration. Weeping and reflecting over the ayat is of its spirit.").font(.body)
                    Text("5. **Make dua in prostration and before the end**, for it is the hour of answer.").font(.body)
                    Text("6. **Close with Witr**: one rak'ah, or three, with the qunut.").font(.body)
                    Text("The Prophet (peace and blessings be upon him) would open his night prayer with this supplication:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**I cannot wake in the last third. Is my prayer still Tahajjud?** Pray what you can after Isha and before sleeping, with Witr. The Prophet advised those who fear they will not wake to pray Witr early. Regularity in a little beats an unkept ambition.").font(.body)
                    Text("**Can I pray Tahajjud sitting?** Yes, and in his later years the Prophet (peace and blessings be upon him) prayed much of the night sitting. Standing is better where you are able.").font(.body)
                    Text("**Should I recite aloud?** He recited sometimes aloud and sometimes softly. Recite so as to hear yourself, and lower it if it disturbs others who sleep or pray.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Rise for part of the night, pray two by two with slow recitation and long dua, and close with Witr. It is the honor of the believer and the hour Allah Himself invites you to ask.")
                        .font(.body)
                }
...
struct DuhaView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **Salat ad-Duha (صَلَاة الضُّحَى)**, the forenoon prayer, is two or more rak'ah prayed after the sun has risen a spear's length until shortly before Dhuhr. Two rak'ah discharge the charity owed by every joint of the body each morning.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("ITS VIRTUE")) {
                    ...
                    Text("It was among the three things the Prophet (peace and blessings be upon him) advised Abu Hurayrah never to leave (Sahih al-Bukhari 1178), and he called it the prayer of those who turn back to Allah:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("ITS TIME")) {
                    Text("It begins about fifteen to twenty minutes after sunrise, when the sun has risen the height of a spear, and ends a little before the sun reaches its zenith. Its best time is when the morning has grown hot, as the hadith of the young camels describes.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HOW MANY RAK'AH")) {
                    Text("The least is two. The Prophet (peace and blessings be upon him) prayed four and added as Allah willed, and prayed eight on the day Makkah was opened:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("HOW TO PRAY IT")) {
                    Text("1. Intend Salat ad-Duha in the heart, at any point in its time.").font(.body)
                    Text("2. Pray two rak'ah at a time, each pair ending with the taslim, as any voluntary prayer.").font(.body)
                    Text("3. Recite what you wish after al-Fatihah; there is no fixed surah.").font(.body)
                    Text("4. Two rak'ah are complete; four, six or eight are more.").font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Did the Prophet pray it every day?** Aishah said he did not pray it regularly except on returning from a journey, while she herself prayed it (Sahih Muslim 717), and others among the Companions saw him pray it. The scholars reconcile this: he left it at times so it would not be taken as obligatory, and he advised his Companions to keep it. Keeping it daily is good, and leaving it some days is no sin.").font(.body)
                    Text("**Is it the same as Salat al-Ishraq?** Ishraq is the name given to Duha prayed at its earliest, right after the sun has risen a spear's length. It is one prayer.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Two rak'ah in the forenoon pay the day's debt of gratitude for every joint in the body. Pray them when the morning is warm, and add to them as you are able.")
                        .font(.body)
                }
...
struct TaraweehView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **Taraweeh (تَرَاوِيح)** is the night prayer of Ramadan, prayed after Isha two rak'ah at a time and closed with Witr, alone or in congregation. Whoever stands in it out of faith and hope of reward is forgiven his past sins.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("ITS VIRTUE")) {
                    ...
                    Text("The Prophet (peace and blessings be upon him) urged it without making it obligatory (Sahih Muslim 759).")
                        .font(.body)
                }

                Section(header: ArticleHeader("HOW IT BEGAN")) {
                    Text("The Prophet (peace and blessings be upon him) prayed it in the mosque for three nights and the people gathered behind him; then he stayed in his house, fearing it would be made obligatory upon them:")
                        .font(.body)
                    ...
                    Text("After his death, Umar (may Allah be pleased with him) gathered the people behind one reciter, Ubayy ibn Ka'b, and said of it “what an excellent innovation this is” (Sahih al-Bukhari 2010), meaning the gathering behind one imam, a Sunnah the Prophet had begun and left only for fear of its becoming obligatory.")
                        .font(.body)
                }

                Section(header: ArticleHeader("HOW MANY RAK'AH")) {
                    Text("The Prophet's own night prayer, in Ramadan and outside it, was eleven rak'ah:")
                        .font(.body)
                    ...
                    Text("The Companions in Umar's time prayed eleven, and later twenty and more with shorter recitation. There is no fixed limit; night prayer is two by two (Sahih al-Bukhari 990). Eleven or thirteen with long, unhurried recitation follows the Prophet most closely; more with shorter recitation is also good. The majority of the scholars, including Ibn Baz and Ibn al-Uthaymin, hold that there is no fixed limit, while some, such as al-Albani, held to eleven; it is a matter of legitimate difference, not of creed.")
                        .font(.body)
                }

                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("1. Pray Isha and its two sunnah rak'ah.").font(.body)
                    Text("2. Pray Taraweeh two rak'ah at a time, with a taslim after every two. Rest briefly after every four if you wish; this rest (**tarwihah**) is what gives the prayer its name.").font(.body)
                    Text("3. In congregation, follow the imam; alone, recite what you know well, slowly.").font(.body)
                    Text("4. Close with Witr, one or three rak'ah with the qunut. If you intend to pray more later in the night, delay Witr to the end.").font(.body)
                    Text("5. Attend to the end: whoever prays with the imam until he finishes is written as having prayed the whole night (Sunan al-Tirmidhi 806; Sunan Abi Dawud 1375; graded sahih by al-Albani).").font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Home or mosque?** Both are Sunnah. The congregation in the mosque is the way of the Companions after Umar, and the imam's recitation carries you through the Quran; at home you may pray at a slower pace. Women may attend the mosque or pray at home.").font(.body)
                    Text("**Can I pray Taraweeh late at night instead of after Isha?** Yes. It is the night prayer; the last third is the best time. In the last ten nights the Prophet stayed up the whole night.").font(.body)
                    Text("**Must the whole Quran be completed?** No. It is a good custom of the imams, not a condition. Praying a small portion with reflection is better than racing through a khatm.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Stand in prayer in the nights of Ramadan, two by two after Isha, closing with Witr, out of faith and hope of reward, and Allah forgives what has passed.")
                        .font(.body)
                }
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("BEFORE THE PRAYER")) {
                    Text("The deceased is washed and shrouded first. The Prophet (peace and blessings be upon him) said of his daughter:")
                        .font(.body)
                    ...
                    Text("Men are shrouded in three cloths; women in three or, according to many scholars, five (the hadith of the five is weak, so al-Albani held that women are shrouded like men), and the funeral is not delayed:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("WHERE TO STAND")) {
                    Text("The body is laid in front of the congregation, its right side toward the qiblah. The imam stands at the head of a man and at the middle of a woman, with the rows behind him.")
                        .font(.body)
                ...
                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("There is no bowing, prostration or sitting. It is four takbirs, all standing:").font(.body)
                    Text("1. **First takbir**: say “Allahu Akbar,” raising the hands, then recite Surah al-Fatihah quietly.").font(.body)
                    Text("2. **Second takbir**: send prayers upon the Prophet (peace and blessings be upon him) with the salat al-Ibrahimiyyah of the tashahhud.").font(.body)
                    Text("3. **Third takbir**: supplicate for the deceased, sincerely, using the Prophet's own words.").font(.body)
                    Text("4. **Fourth takbir**: pause briefly, then give the taslim to the right (and to the left if you wish).").font(.body)
                    Text("Ibn Abbas (may Allah be pleased with him) recited al-Fatihah aloud in a funeral prayer and said:")
                        .font(.body)
                    ...
                    Text("And the Prophet (peace and blessings be upon him) prayed four takbirs over an-Najashi (Sahih al-Bukhari 1245).")
                        .font(.body)
                }

                Section(header: ArticleHeader("THE SUPPLICATION")) {
                    Text("Awf ibn Malik (may Allah be pleased with him) heard the Prophet pray over a deceased man:")
                        .font(.body)
                    ...
                    Text("And for the whole gathering, living and dead:")
                        .font(.body)
                    ...
                    Text("For a woman, change the pronouns to the feminine; for a child, ask that Allah make the child a forerunner and a stored reward for the parents.")
                        .font(.body)
                }

                Section(header: ArticleHeader("AFTER THE PRAYER")) {
                    Text("Follow the funeral to the grave in silence and reflection. The deceased is lowered on the right side facing the qiblah with “Bismillah wa ‘ala sunnati Rasulillah,” the grave is filled, and those present stand and ask forgiveness and steadfastness for him, for he is now being questioned.")
                        .font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Can the prayer be offered for someone absent?** Yes, when the deceased was not prayed over where he died; the Prophet prayed over an-Najashi in Madinah. The scholars differ on doing so for one already prayed over.").font(.body)
                    Text("**I arrived late.** Join with a takbir and follow the imam; after his taslim, complete the takbirs you missed in order before the body is carried away.").font(.body)
                    Text("**Can women pray it?** Yes, in the mosque or at home; Aishah and the wives of the Prophet prayed the funeral prayer for Sa'd ibn Abi Waqqas in the mosque. Following the procession to the grave is for the men.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Four takbirs standing: al-Fatihah, the prayers upon the Prophet, sincere dua for the deceased, and the taslim. Then follow to the grave, and ask steadfastness for a brother or sister who is now being asked.")
                        .font(.body)
                }
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("WHEN TO PRAY IT")) {
                    Text("For any permissible matter whose outcome you cannot see: a marriage, a job, a journey, a purchase, a move. It is not prayed over obligations or prohibitions, for those are already decided, nor over trivial daily choices.")
                        .font(.body)
                    Text("Consult trustworthy people first or alongside it: the Companions took counsel (**istisharah**) and sought Allah's choice (**istikharah**) together.")
                        .font(.body)
                }

                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("1. **Make wudhu** and pray two rak'ah of voluntary prayer with the intention of Istikharah, at any time prayer is permitted. Recite what you wish after al-Fatihah.").font(.body)
                    Text("2. **After the taslim**, raise your hands and say the supplication above, in Arabic if you can, otherwise in your own language. Praise Allah and send prayers upon the Prophet before it.").font(.body)
                    Text("3. **Name the matter** where the hadith says “this matter”: “if You know that marrying so-and-so...” or “this position at...”").font(.body)
                    Text("4. **Then act.** Pursue the matter. If Allah eases it, that is His choice; if He turns it away, that is His choice too. Do not sit waiting for a sign.").font(.body)
                }
                ...
                Section(header: ArticleHeader("THE ARABIC")) {
                    Text("اللَّهُمَّ إِنِّي أَسْتَخِيرُكَ بِعِلْمِكَ وَأَسْتَقْدِرُكَ بِقُدْرَتِكَ، وَأَسْأَلُكَ مِنْ فَضْلِكَ الْعَظِيمِ، فَإِنَّكَ تَقْدِرُ وَلاَ أَقْدِرُ، وَتَعْلَمُ وَلاَ أَعْلَمُ، وَأَنْتَ عَلاَّمُ الْغُيُوبِ. اللَّهُمَّ إِنْ كُنْتَ تَعْلَمُ أَنَّ هَذَا الأَمْرَ خَيْرٌ لِي فِي دِينِي وَمَعَاشِي وَعَاقِبَةِ أَمْرِي فَاقْدُرْهُ لِي وَيَسِّرْهُ لِي ثُمَّ بَارِكْ لِي فِيهِ، وَإِنْ كُنْتَ تَعْلَمُ أَنَّ هَذَا الأَمْرَ شَرٌّ لِي فِي دِينِي وَمَعَاشِي وَعَاقِبَةِ أَمْرِي فَاصْرِفْهُ عَنِّي وَاصْرِفْنِي عَنْهُ، وَاقْدُرْ لِي الْخَيْرَ حَيْثُ كَانَ ثُمَّ أَرْضِنِي بِهِ")
                        .font(settings.scalableIslamArabicFont(base: 22, relativeTo: .title2))
                        ...
                        .foregroundColor(settings.accentColor.color)
                    Text("Allahumma inni astakhiruka bi-‘ilmika, wa astaqdiruka bi-qudratika, wa as'aluka min fadlika al-‘adhim, fa-innaka taqdiru wa la aqdiru, wa ta‘lamu wa la a‘lamu, wa anta ‘allamu al-ghuyub. Allahumma in kunta ta‘lamu anna hadha al-amra khayrun li fi dini wa ma‘ashi wa ‘aqibati amri, faqdurhu li wa yassirhu li thumma barik li fih. Wa in kunta ta‘lamu anna hadha al-amra sharrun li fi dini wa ma‘ashi wa ‘aqibati amri, fasrifhu ‘anni wasrifni ‘anhu, waqdur li al-khayra haythu kana thumma ardini bih.")
                        .font(.footnote)
                        .foregroundColor(.secondary)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Must I see a dream?** No. Nothing in the hadith mentions a dream or a feeling. The answer is in how the matter unfolds after you set out on it.").font(.body)
                    Text("**Can I repeat it?** Yes, if you remain unsure; some of the Salaf repeated it several times. But do not make repetition a way of avoiding a decision.").font(.body)
                    Text("**Can I pray it after a sunnah prayer instead of separate rak'ah?** The hadith says two rak'ah other than the obligatory ones; the scholars allow making the intention of Istikharah in a rawatib or Duha prayer. Two rak'ah prayed for it is the clearest way.").font(.body)
                    Text("**Can someone pray it on my behalf?** The hadith addresses the one concerned with the matter. Ask others for their counsel and their dua, and pray Istikharah yourself.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Two rak'ah, the Prophet's supplication with your matter named, then action. Whatever Allah then opens or closes is the answer, and He decrees the good wherever it is.")
                        .font(.body)
                }
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("THE PERMISSION")) {
                    ...
                    Text("Umar (may Allah be pleased with him) was asked why the shortening remained when the fear had passed. He said he had wondered the same and asked the Prophet, who replied:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("WHO IS A TRAVELER")) {
                    Text("Whoever leaves his town on a journey that is called travel in ordinary speech. Most scholars set a distance of about 80 km (some 48 miles), by the hadith of the Companions; others say any journey with provisions and a night away. Shortening begins once you have left the buildings of your town and ends when you return to them.")
                        .font(.body)
                    Text("On arrival, if you intend to stay four days or fewer you remain a traveler. If you intend longer, most scholars say you pray in full, while others allow shortening as long as you have not settled, since the Prophet shortened during his nineteen days at Makkah:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("SHORTENING (QASR)")) {
                    Text("• **Dhuhr, Asr and Isha**: two rak'ah each.").font(.body)
                    Text("• **Fajr**: two, as always. **Maghrib**: three, as always.").font(.body)
                    Text("• The rawatib are dropped on a journey except the two before Fajr and Witr, which the Prophet (peace and blessings be upon him) never left. Other voluntary prayers remain permitted.").font(.body)
                    Text("• Praying behind a resident imam, the traveler completes four with him.").font(.body)
                ...
                Section(header: ArticleHeader("COMBINING (JAM')")) {
                    Text("Combining is a concession for hardship while actually on the move, not a fixed rule of travel. Dhuhr may be brought to Asr's time or Asr brought forward to Dhuhr's; Maghrib and Isha likewise. Each prayer is prayed complete in itself, one after the other, with one adhan and two iqamahs.")
                        .font(.body)
                    ...
                    Text("Combining is also allowed for a resident in hard rain, illness, or a genuine hardship, by the report of Ibn Abbas that the Prophet combined in Madinah without fear or travel so that his ummah not be put to difficulty (Sahih Muslim 705).")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Is shortening obligatory or optional?** The Prophet never prayed four on a journey and neither did his Companions, so shortening is the Sunnah and the safer course. Most scholars hold completing is valid but disliked; some hold shortening is required.").font(.body)
                    Text("**I am traveling but staying in one place for a week. Do I combine?** It is better not to: in a hotel or a relative's home pray each prayer in its time, shortened if you are still a traveler. Combining while stopped is permitted when there is a need, since the Prophet (peace and blessings be upon him) combined while encamped at Tabuk (Sahih Muslim 706).").font(.body)
                    Text("**What about fasting?** A traveler may break the fast and make it up; if fasting is easy, fasting is better. Allah says: whoever is ill or on a journey, then an equal number of other days (Quran 2:185).").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("On a journey pray the four-rak'ah prayers as two, combine when moving makes the times hard, keep the two of Fajr and Witr, and accept the charity Allah has given you.")
                        .font(.body)
                }
...
struct SickPrayerView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: illness never removes the prayer; it removes only what you cannot do. Pray standing if you can, sitting if you cannot, lying on your side if you cannot sit, and with the eyes and heart if you cannot move. Allah burdens no soul beyond its capacity.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("THE PRINCIPLE")) {
                    ...
                    Text("Imran ibn Husayn (may Allah be pleased with him), who suffered from piles, asked the Prophet (peace and blessings be upon him) about prayer. He said:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("1. **Standing** is required in the obligatory prayer for whoever can. Lean on a wall or a stick if that lets you stand.").font(.body)
                    Text("2. **If standing is impossible or harmful**, sit, cross-legged or as is comfortable, and bow by bending forward from the sitting position. Prostrate on the ground if you can.").font(.body)
                    Text("3. **If sitting on the ground is impossible**, sit on a chair, and prostrate on the ground if possible; if not, bow and prostrate by bending forward, the prostration lower than the bow.").font(.body)
                    Text("4. **If sitting is impossible**, lie on your right side facing the qiblah, and perform the bowing and prostration by tilting the head.").font(.body)
                    Text("5. **If even that is impossible**, lie on your back with the feet toward the qiblah, and make the movements with the head; if even that is impossible, the heart intends each pillar (there is no authentic basis for gesturing with the eyes).").font(.body)
                    Text("6. Recite as usual; if the tongue cannot, recite in the heart. The prayer is never dropped while the mind is present.").font(.body)
                }

                Section(header: ArticleHeader("THE REWARD OF THE SEATED")) {
                    Text("Sitting when standing is possible halves the reward of a voluntary prayer; sitting out of inability loses nothing:")
                        .font(.body)
                    ...
                    Text("The scholars explain that this halving is for the able who choose to sit in voluntary prayer. The one who is unable and does what he can has his full reward, by the hadith that the servant is written the reward of what he used to do in health when illness or travel prevents him (Sahih al-Bukhari 2996).")
                        .font(.body)
                }

                Section(header: ArticleHeader("PURIFICATION WHEN ILL")) {
                    Text("• If water harms you, make tayammum on clean earth, a dusty wall, or a container of earth kept by the bed.").font(.body)
                    Text("• If you cannot move, someone may help you make wudhu or tayammum.").font(.body)
                    Text("• A wound or cast is wiped over; the rest is washed.").font(.body)
                    Text("• One with incontinence or continuous bleeding makes wudhu for each prayer after its time begins and prays; what escapes afterward does not harm.").font(.body)
                    Text("• Impure clothes or bedding are changed or washed when possible; if not, pray as you are.").font(.body)
                }

                Section(header: ArticleHeader("COMBINING WHEN ILL")) {
                    Text("A sick person for whom praying each prayer in its time is a real hardship may combine Dhuhr with Asr and Maghrib with Isha, at either time, as the traveler does. The scholars draw this from the Prophet's combining in Madinah without fear or travel (Sahih Muslim 705) and from his instruction to the woman with prolonged bleeding.")
                        .font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**I was unconscious for a day. Do I make up the prayers?** If unconsciousness lasted a short period, make them up; if it was prolonged (three days or more, by the view of many scholars), there is no make-up, as the pen is lifted from one without awareness. A person asleep makes up what he missed.").font(.body)
                    Text("**Can I pray on a hospital bed facing away from the qiblah?** Face it if you can, even by asking to be turned; if you cannot, pray as you are. The obligation is according to ability.").font(.body)
                    Text("**Chair or floor?** The floor, so that the prostration is on the ground, unless standing up from the floor or prostrating harms you. Use the chair for what you cannot do and the floor for what you can.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Standing, then sitting, then lying down, then the head and the eyes: the prayer follows your ability and never leaves you. Do what you can, and the reward of what you cannot is written for you.")
                        .font(.body)
                }
...
struct MissedPrayerView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: a prayer missed through sleep or forgetting is prayed as soon as you remember, in order, and that is its only expiation. Prayers left deliberately are a grave matter to be repented from at once; the scholars differ on whether they can be made up, and all agree on repentance and on guarding what remains.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("SLEEP AND FORGETTING")) {
                    ...
                    Text("And he recited: “And establish prayer for My remembrance” (Quran 20:14). The Prophet (peace and blessings be upon him) himself once slept through Fajr on a journey and prayed it when the Companions woke, after the sun had risen (Sahih al-Bukhari 595). He said:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("1. **Pray it at once** on waking or remembering, even if it is a forbidden time for voluntary prayer; a missed obligatory prayer has no forbidden time.").font(.body)
                    Text("2. **Keep the order.** If you missed Dhuhr and remember at Asr, pray Dhuhr first and then Asr, as the Prophet prayed Asr before Maghrib on the day of the Trench:").font(.body)
                    ...
                    Text("3. **Pray it as it would have been prayed**: the same number of rak'ah, aloud or quietly as its time calls for. A traveler who missed a prayer while traveling makes it up shortened.").font(.body)
                    Text("4. **Order is dropped** if the current prayer's time would run out, or if you did not remember the missed one until after it.").font(.body)
                    Text("5. **Make wudhu with care** and pray it with the presence of the one grateful to have remembered.").font(.body)
                }

                Section(header: ArticleHeader("PRAYERS LEFT ON PURPOSE")) {
                    Text("Leaving the prayer knowingly is the gravest of sins after shirk, and the Prophet (peace and blessings be upon him) placed it at the boundary of faith:")
                        .font(.body)
                    ScriptureQuote(text: "“Verily between man and between polytheism and unbelief is the negligence of prayer” (Sahih Muslim 82).", arabic: "إِنَّ بَيْنَ الرَّجُلِ وَبَيْنَ الشِّرْكِ وَالْكُفْرِ تَرْكَ الصَّلاَةِ", dimmed: true)
                    Text("The scholars hold two views on making up what was left deliberately. The majority say: make them up, as many as you can estimate, alongside repentance, and the debt to Allah is paid with the prayers themselves. Others, among them Ibn Taymiyyah and Ibn Hazm, say a prayer deliberately left has no valid make-up, for it was tied to its time, and the door is sincere repentance and abundant voluntary prayer. On both views, repent immediately, guard every remaining prayer, and fill your days with voluntary prayer, for the voluntary completes what the obligatory lacked.")
                        .font(.body)
                }

                Section(header: ArticleHeader("PREVENTION")) {
                    Text("• Set an alarm for Fajr and sleep early; the Prophet disliked talk after Isha (Sahih al-Bukhari 568).").font(.body)
                    Text("• Ask someone to wake you, as the Companions kept watch for one another.").font(.body)
                    Text("• Pray each prayer at the start of its time when you can; the best deed is prayer at its time.").font(.body)
                    Text("• Say the sleeping remembrances and make the intention to rise; if sleep still overcomes you, you are excused.").font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Do I make up the Sunnah prayers too?** The rawatib may be made up, especially the two of Fajr, which the Prophet prayed after the obligatory Fajr when the Companions slept through. Witr missed by sleep is prayed when you wake.").font(.body)
                    Text("**A woman missed prayers during menses.** They are not made up; the fast of Ramadan is. Prayers missed before the bleeding began, whose time had entered, are made up.").font(.body)
                    Text("**I do not know how many I missed.** Estimate generously and pray until you are confident you have covered them, one day's worth at a time, without a hardship that makes you abandon it.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Missed by sleep or forgetting: pray it the moment you remember, in order. Left deliberately: repent now, guard what remains, and make up or fill in with voluntary prayer as the scholars you follow direct.")
                        .font(.body)
                }
...
struct SujudSahwView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **Sujud as-Sahw (سُجُود السَّهو)** is two prostrations that repair a slip in the prayer: something added, something omitted, or a doubt about the count. For an omission or doubt they are made before the taslim; for an addition or an early taslim, after it. The Prophet (peace and blessings be upon him) forgot in prayer and taught his ummah exactly what to do.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("THREE CASES")) {
                    ...
                    Text("**3. A doubt about the count**: if one side seems more likely, act on it and prostrate after the taslim. If neither does, build on what you are certain of, the smaller number, and prostrate before the taslim:").font(.body)
                ...
                Section(header: ArticleHeader("AN EARLY TASLIM")) {
                    Text("Whoever gives the taslim before the prayer is complete, then realizes, completes what remains and prostrates after the taslim, as the Prophet did on the day of Dhul-Yadayn:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("HOW TO PERFORM IT")) {
                    Text("1. Say “Allahu Akbar” and prostrate as in the prayer, saying “Subhana Rabbi al-A'la.”").font(.body)
                    Text("2. Sit up with “Allahu Akbar,” then prostrate a second time.").font(.body)
                    Text("3. If they were before the taslim, sit and give the taslim. If after, give the taslim again; a second tashahhud is not required, though some scholars allow it.").font(.body)
                    Text("Behind an imam, follow him: you do not prostrate for your own slip while he leads, but you prostrate with him for his, and for a slip in what you pray alone after him.").font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**I remembered a missed sujud as-sahw only after leaving.** If a short time has passed, prostrate where you are; if long, the prayer stands and there is nothing owed.").font(.body)
                    Text("**Does reciting the wrong surah or a slip of the tongue call for it?** No. It is for the actions of the prayer, not the choice of recitation, and mispronunciation is corrected when noticed.").font(.body)
                    Text("**What if I doubt constantly?** Persistent doubt from whispers is ignored; build on the most likely and continue. Sujud as-sahw is for real doubt, not for a habit of doubting.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Added something: prostrate twice after the taslim. Left something or unsure: build on what is certain and prostrate twice before it. Two prostrations mend the prayer and humble Satan.")
                        .font(.body)
                }
...
struct VoluntaryFastsView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: beyond Ramadan, the Prophet (peace and blessings be upon him) fasted and recommended Mondays and Thursdays, three days a month, the six days of Shawwal, the day of Arafah, Ashura, and much of Sha'ban and Muharram. Each fast is intended before dawn (or, for a voluntary fast, during the day if nothing has been eaten) and observed as Ramadan is.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("MONDAYS AND THURSDAYS")) {
                    ...
                    Text("Of Monday in particular he said:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("THREE DAYS A MONTH")) {
                    Text("Three days every month equal a lifetime of fasting, since each good deed is tenfold. The Prophet (peace and blessings be upon him) named the white days, the 13th, 14th and 15th, whose nights are lit by the full moon:")
                        .font(.body)
                    ...
                    Text("Aishah said he fasted three days of every month and did not mind which days they were (Sahih Muslim 1160).")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("THE SIX OF SHAWWAL")) {
                    ...
                    Text("They may be fasted consecutively or spread through the month, after Eid al-Fitr. Those with days of Ramadan to make up should make them up first, so the “Ramadan” in the hadith is complete.")
                        .font(.body)
                }

                Section(header: ArticleHeader("ARAFAH AND ASHURA")) {
                    Text("Asked about the fast of the day of Arafah (9 Dhul-Hijjah), the Prophet (peace and blessings be upon him) said it expiates the year before and the year after; and of Ashura (10 Muharram), that it expiates the year before (Sahih Muslim 1162). The pilgrim at Arafah does not fast; everyone else is urged to. The nine days before Eid al-Adha are the best days for good deeds:")
                        .font(.body)
                    ...
                    Text("When the Prophet (peace and blessings be upon him) came to Madinah he found the Jews fasting Ashura in gratitude for the day Allah saved the Children of Israel from their enemy, the day Musa fasted. He said:")
                        .font(.body)
                    ...
                    Text("So he fasted it and commanded that it be fasted (Sahih al-Bukhari 2004), and toward the end of his life he intended to add the ninth to it:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("SHA'BAN AND MUHARRAM")) {
                    ...
                    Text("And the best month to fast after Ramadan is Muharram (Sahih Muslim 1163). The fast of Dawud, every other day, is the most beloved fast to Allah (Sahih al-Bukhari 1131).")
                        .font(.body)
                }

                Section(header: ArticleHeader("HOW TO OBSERVE THEM")) {
                    Text("1. **Intend** the fast. A voluntary fast may be intended in the morning if you have not yet eaten or drunk since dawn; the Prophet would ask for food and, finding none, say “then I am fasting” (Sahih Muslim 1154).").font(.body)
                    Text("2. **Take suhur** if you can and break the fast at sunset, as in Ramadan.").font(.body)
                    Text("3. **Refrain** from what breaks the fast and from what spoils it: argument, foul speech, and idle talk.").font(.body)
                    Text("4. **You may break a voluntary fast** if a need arises, without sin; making it up is recommended, not required.").font(.body)
                    Text("5. **A wife** fasts voluntarily only with her husband's permission when he is present (Sahih al-Bukhari 5192).").font(.body)
                }
                ...
                Section(header: ArticleHeader("DAYS NOT TO FAST")) {
                    ...
                    Text("Fasting is forbidden on the two Eids (Sahih al-Bukhari 1991) and on the three days of Tashriq after Eid al-Adha:")
                        .font(.body)
                    ...
                    Text("Nor should one fast perpetually or wear the body down; the Prophet (peace and blessings be upon him) said to Abdullah ibn Amr that whoever fasts every day has not fasted, and guided him to the fast of Dawud (Sahih al-Bukhari 1979).")
                        .font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Mondays and Thursdays, three white days a month, six of Shawwal, Arafah, Ashura, and much of Sha'ban: fasts the Prophet loved, each intended and kept as Ramadan is, and each a shield and an expiation.")
                        .font(.body)
                }
...
struct ItikafView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **I'tikaf (اِعتِكَاف)** is to withdraw into a mosque and remain there for worship, leaving only for what is necessary. The Prophet (peace and blessings be upon him) observed it every year in the last ten nights of Ramadan, seeking Laylat al-Qadr, until he died.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("ITS BASIS")) {
                    ...
                    Text("He said he sought the Night of Decree by it, and told the people:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("WHERE AND WHEN")) {
                    Text("• **Where**: a mosque in which the congregational prayers are held, so that i'tikaf does not make you miss them. The three sacred mosques are the most excellent for it.").font(.body)
                    Text("• **When**: the Sunnah is the last ten nights of Ramadan. Enter the mosque before sunset on the 20th, the eve of the 21st night, and leave after sunset on the last day (or, as the Prophet did, go from the mosque to the Eid prayer). I'tikaf outside Ramadan and for a shorter time is also valid.").font(.body)
                ...
                Section(header: ArticleHeader("HOW TO OBSERVE IT")) {
                    Text("1. **Intend** i'tikaf for Allah; a vowed i'tikaf must be completed, a voluntary one may be left.").font(.body)
                    Text("2. **Set your place**: a corner or a small tent within the mosque, as the Prophet had a tent pitched for him (Sahih al-Bukhari 2033).").font(.body)
                    Text("3. **Fill the time** with prayer, recitation, dhikr, dua, seeking forgiveness, and learning. Speak little of the world; sleep only what you need.").font(.body)
                    Text("4. **Leave only for need**: the toilet, a ghusl, food when it cannot be brought, and for Jumuah if the mosque does not hold it. Do not visit the sick or attend funerals during it unless you had stipulated so.").font(.body)
                    Text("5. **Keep away from intimacy** with a spouse; this breaks the i'tikaf. Visits, speaking and being served are permitted:").font(.body)
                ...
                Section(header: ArticleHeader("WHAT BREAKS IT")) {
                    Text("Leaving the mosque without need, intimacy, and losing one's mind or faith. Menses and post-natal bleeding require leaving. Illness may compel leaving, after which one returns when able.")
                        .font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Can women do i'tikaf?** Yes, in the mosque, with a screened place and their guardian's leave; the Prophet's wives did so after him. A woman does not observe i'tikaf at home, for the Quran ties it to the mosques.").font(.body)
                    Text("**Can I do i'tikaf for one night or one day?** Yes. Whoever cannot manage ten days may observe what he can, even the odd nights, or a single night.").font(.body)
                    Text("**Can I use my phone?** What draws you to Allah, yes: the Quran, the adhkar, learning. What draws you back to the world defeats the purpose; put it away.").font(.body)
                    Text("**Is fasting a condition?** In Ramadan it is already fasting. Outside it, many scholars, including the Hanbalis and Ibn Baz, do not make fasting a condition (the Hanafis and Malikis require it), though observing it fasting is better.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Withdraw into the mosque in the last ten nights, leave only for need, and give the whole of yourself to Allah in search of a night better than a thousand months.")
                        .font(.body)
                }
...
struct ZakatFitrView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **Zakat al-Fitr (زَكَاة الفِطر)** is one sa' of staple food, about 2.5 to 3 kg, given for every Muslim in the household before the Eid al-Fitr prayer. It purifies the fasting person from idle talk and feeds the poor on the day of Eid.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("WHO GIVES AND FOR WHOM")) {
                    Text("Every Muslim who has food beyond his need for the day and night of Eid gives it for himself and for those he supports: wife, children, and dependents. It is not conditioned on the nisab of the annual zakah. It is recommended, and in the view of many required, to give it for a child born before sunset on the last day of Ramadan, and a family may give for the unborn as Uthman did, though that is not obligatory.")
                        .font(.body)
                }

                Section(header: ArticleHeader("WHAT AND HOW MUCH")) {
                    Text("One **sa' (صَاع)**, the Prophet's measure of about four double handfuls, of the staple food of the land: dates, barley, wheat, raisins, rice, or the like. Abu Sa'id (may Allah be pleased with him) said:")
                        .font(.body)
                    ...
                    Text("By weight, one sa' is about 2.5 kg of wheat and closer to 3 kg of rice; giving 3 kg is safe. The Sunnah is to give food itself. Some scholars allow its value in money when that benefits the poor more; the majority hold to food, as the Prophet legislated it.")
                        .font(.body)
                }

                Section(header: ArticleHeader("WHEN")) {
                    Text("Its time is from sunset on the last day of Ramadan until the Eid prayer; the best is the morning of Eid before the prayer. It may be given a day or two earlier, as the Companions did:")
                        .font(.body)
                    ...
                    Text("Delaying it past the prayer without excuse is a sin; it must still be given.")
                        .font(.body)
                }

                Section(header: ArticleHeader("TO WHOM")) {
                    Text("To the poor and needy Muslims of your town. It may be given directly or through a trusted person or mosque who delivers it in time; one sa' may be split among several, and several sa' may be given to one.")
                        .font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("A sa' of food for every member of the house, in the hands of the poor before the Eid prayer: it seals the fast and gives everyone a share in the joy of Eid.")
                        .font(.body)
                }
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("ITS BASIS")) {
                    ...
                    Text("It is a confirmed Sunnah for every household that can afford it; some scholars hold it obligatory on the able, so whoever can should not leave it.")
                        .font(.body)
                }

                Section(header: ArticleHeader("THE ANIMAL")) {
                    Text("• **Kind**: a sheep or goat (for one person and his household), or a cow or camel (which seven may share).").font(.body)
                    Text("• **Age**: a sheep of at least six months, a goat of one year, a cow of two, a camel of five.").font(.body)
                    ...
                    Text("• **Free of defects**: not one-eyed, not visibly sick, not lame, and not emaciated. Al-Bara' ibn Azib narrated the four the Prophet excluded (Sunan Abi Dawud 2802). Choose the best you can; it is a gift to Allah.").font(.body)
                }

                Section(header: ArticleHeader("BEFORE EID")) {
                    Text("Whoever intends to sacrifice does not cut hair or nails from the first of Dhul-Hijjah until the sacrifice:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("WHEN")) {
                    Text("After the Eid prayer on the 10th of Dhul-Hijjah, until sunset on the 13th. Slaughtering before the prayer is not a sacrifice:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("1. **Sharpen the knife** out of the animal's sight, and treat it gently; water it and lead it kindly.").font(.body)
                    Text("2. **Lay it on its left side facing the qiblah**, foot on its flank, as the Prophet did. A camel is slaughtered standing with its left foreleg tied.").font(.body)
                    Text("3. **Say “Bismillah, Allahu Akbar”**, and if you wish: “O Allah, this is from You and for You, from me (and my family).”").font(.body)
                    Text("4. **Cut swiftly** across the throat, severing the windpipe, gullet and the two jugulars, without severing the head, and let the animal go still before skinning.").font(.body)
                    Text("5. It is best to slaughter with your own hand; otherwise appoint someone and be present. A woman may slaughter.").font(.body)
                ...
                Section(header: ArticleHeader("THE MEAT")) {
                    Text("Eat from it, give some as gifts, and give some to the poor; a third each is a fine division, not a fixed rule. Nothing of it is sold, not even the skin, and the butcher is not paid from it. Storing beyond three days was once forbidden and then permitted:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Can one sheep suffice for the whole family?** Yes. The Prophet sacrificed one ram for himself and his household and another for his ummah. Separate sacrifices per person are not required.").font(.body)
                    Text("**Can I have it done abroad?** It is valid to appoint a trustworthy agency to slaughter and distribute on your behalf. Slaughtering where you are, with your own hand, and eating from it is the fuller Sunnah.").font(.body)
                    Text("**I cannot afford it.** There is no sin. Udhiyah is for the able; the poor share in its meat.").font(.body)
                    Text("**Is Udhiyah the same as the pilgrim's hady?** No. The hady is the pilgrim's offering in Makkah; the Udhiyah is for the Muslims at home.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("A sound animal, after the Eid prayer, with the Name of Allah and the takbir, eaten and shared: the Udhiyah renews the surrender of Ibrahim and turns Eid into a feast for the poor.")
                        .font(.body)
                }
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("THE TESTIMONY")) {
                    Text("Say, understanding and meaning it:")
                        .font(.body)
                    Text("أَشْهَدُ أَنْ لَا إِلَٰهَ إِلَّا اللَّهُ، وَأَشْهَدُ أَنَّ مُحَمَّدًا رَسُولُ اللَّهِ")
                        .font(settings.scalableIslamArabicFont(base: 24, relativeTo: .title2))
                        .arabicFontDesign(custom: settings.islamUsesCustomArabicFace)
                        .multilineTextAlignment(.trailing)
                        .fixedSize(horizontal: false, vertical: true)
                        .frame(maxWidth: .infinity, alignment: .trailing)
                    ...
                    Text("Ash-hadu an la ilaha illa Allah, wa ash-hadu anna Muhammadan Rasulullah.")
                        .font(.footnote)
                        .foregroundColor(.secondary)
                    Text("“I bear witness that there is no deity except Allah, and I bear witness that Muhammad is the Messenger of Allah.”")
                        .font(.body)
                    Text("Its first half denies every object of worship other than Allah and affirms Him alone; its second half binds you to follow His Messenger. Saying it sincerely, knowing what it means, with no reservation, is what makes a Muslim:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("STEP BY STEP")) {
                    Text("1. **Believe.** Know that Allah alone is the Creator and the only One worthy of worship, that Muhammad is His final Messenger, and that the Quran is His word. Doubt is not a barrier to beginning; sincerity is the condition.").font(.body)
                    Text("2. **Say the Shahadah** aloud, in Arabic and in your language. Alone is valid; before witnesses is a joy and a help, but not a condition.").font(.body)
                    Text("3. **Take a bath (ghusl)**: the Prophet (peace and blessings be upon him) told Qays ibn Asim, on his embracing Islam, to bathe (Sunan Abi Dawud 355), and Thumamah bathed before he came to declare his Islam (Sahih al-Bukhari 462).").font(.body)
                    Text("4. **Learn to pray**, beginning at once. The prayer is the first thing Islam asks after the testimony; learn wudhu, al-Fatihah, and the movements, and pray what you know while you learn the rest.").font(.body)
                    Text("5. **Learn gradually**: the pillars of faith, the halal and haram, the Quran. Islam was revealed over twenty-three years; the Prophet taught Mu'adh to begin with the testimony, then the prayer, then the zakah (Sahih al-Bukhari 1395).").font(.body)
                    Text("6. **Find company**: a mosque, a teacher, and believing friends. Keep your name unless it carries a meaning of shirk; changing it is not required.").font(.body)
                }

                Section(header: ArticleHeader("WHAT IT EARNS YOU")) {
                    Text("Everything before it is wiped away. Amr ibn al-As (may Allah be pleased with him), on his deathbed, recalled that when he came to give his hand in Islam he asked for his past to be forgiven, and the Prophet said:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("STAYING FIRM")) {
                    Text("Sufyan ibn Abdullah asked the Prophet (peace and blessings be upon him) for a word about Islam that would need no other. He said:")
                        .font(.body)
                    ...
                    Text("Pray on time, keep the company of the righteous, read the Quran daily, ask when you do not know, and never despair of Allah's mercy over a slip. Faith rises and falls; the Prophet said that the strongest handhold of faith is love for Allah's sake and hate for His sake (Musnad Ahmad 18524; graded hasan by al-Albani, Sahih al-Jami' 2539).")
                        .font(.body)
                }

                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Do I need to go to a mosque or an imam?** No. The testimony between you and Allah is complete. A certificate is useful for Hajj visas and marriage in some countries, and the mosque is where you will learn, so go, but Islam did not wait for it.").font(.body)
                    Text("**Do I have to tell my family?** Not as a condition. Wisdom, kindness and good character are your best witness. Honor your parents whatever their faith; Allah commands it.").font(.body)
                    Text("**I still have questions and doubts.** So did the Companions before certainty settled. Ask, read, and pray; knowledge removes doubt. Do not delay the testimony you already believe.").font(.body)
                    Text("**Must I be circumcised, change my name, or learn Arabic first?** No. Circumcision is prescribed for men (obligatory according to many scholars) but is not a condition of entering Islam and may be delayed; the name stays unless its meaning is un-Islamic; Arabic comes with time, beginning with al-Fatihah.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Believe, bear witness, bathe, pray, and learn. The testimony wipes away all that came before, and the rest of Islam is walked one step at a time.")
                        .font(.body)
                }
        ...
        List {
            Group {
                ...
                Section(header: ArticleHeader("THE CONDITIONS")) {
                    Text("1. **Stop the sin** at once. Repentance while continuing is a claim, not a return.").font(.body)
                    Text("2. **Regret** it in the heart; regret is the heart of repentance.").font(.body)
                    Text("3. **Resolve firmly** never to return to it.").font(.body)
                    Text("4. **Restore what belongs to others**: return wealth, seek the pardon of the one wronged, or make good the wrong. The Prophet (peace and blessings be upon him) said:").font(.body)
                    ...
                    Text("5. **Sincerity**: repentance for Allah's sake, not for fear of people or loss of standing.").font(.body)
                    Text("6. **Before it is too late**: while the soul is in the body and before the signs of the Hour. Allah accepts the repentance of His servant until the death rattle (Sunan al-Tirmidhi 3537; graded hasan by al-Albani).").font(.body)
                }

                Section(header: ArticleHeader("HOW TO REPENT")) {
                    Text("• **Make wudhu and pray two rak'ah**, then ask forgiveness with the tongue and the heart (Sunan Abi Dawud 1521; graded sahih by al-Albani). Any time is its time.").font(.body)
                    Text("• **Say “Astaghfirullah”** (I seek Allah's forgiveness), and the best of it, the master supplication of forgiveness:").font(.body)
                    ...
                    Text("• **Follow the sin with a good deed**:").font(.body)
                    ...
                    Text("• **Conceal it**: a sin between you and Allah is not to be told to people. Ask His forgiveness; do not seek theirs for what they never knew.").font(.body)
                    Text("• **Leave what leads to it**: the company, the place, the habit.").font(.body)
                }

                Section(header: ArticleHeader("IF YOU FALL AGAIN")) {
                    Text("Repent again. Returning to a sin does not cancel the earlier repentance, and the door does not shut for repeating. Allah said of a servant who sinned, repented, and sinned again:")
                        .font(.body)
                    ...
                    Text("This is for the one whose repentance each time is sincere, not for one who repents in word intending to return. The Prophet (peace and blessings be upon him) himself said:")
                        .font(.body)
                ...
                Section(header: ArticleHeader("COMMON QUESTIONS")) {
                    Text("**Do I have to confess to anyone?** No. Confession is to Allah alone. The only exception is a wrong done to a person, whose right must be restored or pardoned.").font(.body)
                    Text("**I cannot find the person I wronged.** Return the wealth to his heirs; if that is impossible, give it in charity on his behalf and ask Allah to forgive you. For a wrong to his honor, make dua for him and speak well of him where you spoke ill.").font(.body)
                    Text("**Can shirk be forgiven?** Yes, by repentance in this life. What is not forgiven is dying upon it. Whoever enters Islam or returns to tawhid before death has everything before it wiped away.").font(.body)
                    Text("**How do I know it was accepted?** By the sign the scholars name: you are better after it than before. Have good hope in Allah, for He is as His servant thinks Him to be.").font(.body)
                }

                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Stop, regret, resolve, restore, and ask. Allah stretches out His hand every night and every day for exactly this, and He rejoices in your return.")
                        .font(.body)
                }
...
struct MakeDuaView: View {
    ...
    var body: some View {
        List {
            Group {
                Section(header: ArticleHeader("SUMMARY")) {
                    Text("In short: **Dua (دُعَاء)** is worship itself: calling on Allah alone, with certainty, humility, praise and persistence, at the times and in the states He loves. Every sincere dua is answered: granted, deferred to the Hereafter, or exchanged for a harm turned away.")
                        .font(.body)
                }
                ...
                Section(header: ArticleHeader("THE MANNERS OF DUA")) {
                    Text("1. **Sincerity**: ask Allah alone, with no intermediary, calling on none but Him.").font(.body)
                    Text("2. **Begin with praise** of Allah and prayers upon the Prophet (peace and blessings be upon him), and end with them.").font(.body)
                    Text("3. **Face the qiblah and raise the hands**, palms up, as he did at Badr and at Arafah.").font(.body)
                    ...
                    Text("4. **Ask with certainty**, resolutely, and lower your voice:").font(.body)
                    ...
                    Text("5. **Repeat** your request, three times as the Prophet did, and be persistent over the days.").font(.body)
                    Text("6. **Ask for everything**, the great and the small, for yourself, your parents and the believers, and for the Hereafter above the world.").font(.body)
                    Text("7. **Use the Names of Allah** suited to your need, and the Prophet's own words where you know them.").font(.body)
                    Text("8. **Keep your earnings and food lawful**; a body fed on the unlawful is slow to be answered:").font(.body)
                ...
                Section(header: ArticleHeader("THE TIMES OF ANSWER")) {
                    Text("• **The last third of the night**, when Allah descends and asks who is calling on Him (Sahih al-Bukhari 1145).").font(.body)
                    Text("• **In prostration**:").font(.body)
                    ...
                    Text("• **Between the adhan and the iqamah**:").font(.body)
                    ...
                    Text("• **After the tashahhud before the taslim**, and after the obligatory prayers.").font(.body)
                    Text("• **An hour on Friday**, which the scholars place at the end of the day before Maghrib or between the khutbah and the prayer (Sahih al-Bukhari 935).").font(.body)
                    Text("• **When rain falls, when traveling, and when oppressed**:").font(.body)
                    ...
                    Text("• **On the day of Arafah, in Ramadan, and in Laylat al-Qadr**, and at Zamzam for the pilgrim.").font(.body)
                }

                Section(header: ArticleHeader("WHAT TO AVOID")) {
                    Text("• Asking for a sin, or against family ties.").font(.body)
                    Text("• Giving up: “I asked and was not answered.”").font(.body)
                    Text("• Asking through the dead or the absent; dua is directed to Allah alone, and the living may be asked to pray for you.").font(.body)
                    Text("• Hurried, distracted asking with a heedless heart; gather the heart before the tongue speaks.").font(.body)
                    Text("• Rhyming and affectation in wording, and raising the voice unduly; Allah is near.").font(.body)
                }

                Section(header: ArticleHeader("THE THREE ANSWERS")) {
                    Text("The Prophet (peace and blessings be upon him) taught that no Muslim makes a dua free of sin and the cutting of ties except that Allah gives him one of three: his request soon, or its storing for the Hereafter, or the turning away of an equal harm (Musnad Ahmad 11133; graded hasan). Whoever understands this never counts a dua unanswered.")
                        .font(.body)
                ...
                Section(header: ArticleHeader("IN SUMMARY")) {
                    Text("Praise Him, send prayers on His Prophet, raise your hands, ask with certainty and persistence at the hours He loves, and know that no sincere call to Allah is ever lost.")
                        .font(.body)
                }
            }
            .themedListRowBackground()
