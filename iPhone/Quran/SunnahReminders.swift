...
struct SunnahReminderPreset: Identifiable {
    ...
    static let all: [SunnahReminderPreset] = [
        SunnahReminderPreset(
            ...
            arabicTitle: "الْوِرْدُ الْيَوْمِيّ",
            transliteration: nil,
        ...
        SunnahReminderPreset(
            ...
            arabicTitle: "السَّجْدَة وَالْإِنْسَان",
        ...
        SunnahReminderPreset(
            ...
            arabicTitle: "خَوَاتِيمُ آلِ عِمْرَان",
