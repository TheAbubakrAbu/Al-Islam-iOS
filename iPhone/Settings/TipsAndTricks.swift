...
enum TipCatalog {
    ...
    private static let adhan: [AppTip] = [
        ...
        AppTip(id: "adhan.skyline", area: .adhan, group: "THE SKY", systemImage: "building.columns.fill",
               ...
               detail: "Skyline draws a mosque, pyramids, and palm trees along the horizon, in the app and on the Solar Arc and Day & Night widgets.",
    ...
    private static let quran: [AppTip] = [
        ...
        AppTip(id: "quran.operators", area: .quran, group: "SEARCH", systemImage: "equal.circle",
               title: "Search operators",
               detail: "=word matches a whole word, ^word the start of an ayah, word% the end of one, and &, |, and ! combine them. The Ayah Search Guide in the search help lists them all.",
    ...
    private static let hadith: [AppTip] = [
        ...
        AppTip(id: "hadith.reference", area: .hadith, group: "SEARCH", systemImage: "arrow.right.circle.fill",
               ...
               detail: "Search \u{201C}bukhari 5103\u{201D} or \u{201C}muslim 3:12\u{201D} to open that exact narration. A bare number finds that chapter and that hadith in every collection.",
    ...
    private static let general: [AppTip] = [
        ...
        AppTip(id: "app.reset", area: .app, group: "YOU", systemImage: "arrow.counterclockwise",
               ...
               detail: "Reset All Settings offers two choices: put every option back and keep your bookmarks, favorites, and progress, or erase everything.",
               place: "Settings tab"),

        AppTip(id: "app.themes", area: .app, group: "HOW IT LOOKS", systemImage: "paintpalette.fill",
               title: "Reading themes",
               detail: "Beyond light and dark there are Gray and Sepia themes and a background color of your own, with any accent color to match.",
        ...
        AppTip(id: "app.classic", area: .app, group: "HOW IT LOOKS", systemImage: "square.on.square",
               ...
               place: "Settings tab, Appearance", destination: .appearance, isAvailable: { hasLiquidGlass }),
        AppTip(id: "app.glow", area: .app, group: "HOW IT LOOKS", systemImage: "sun.haze.fill",
               ...
               place: "Settings tab, Appearance", destination: .appearance),
    ]
}
